                                        ...
                                        <tr>
                                            <td height="46" align="right" valign="middle">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tbody>
                                                    <tr>
                                                    <td width="96%" align="right"><font style="font-family:'Myriad Pro',Helvetica,Arial,sans-serif;color:#68696a;font-size:20px;text-transform:uppercase"><a href="http:// " style="color:#68696a;text-decoration:none" target="_blank" ><strong><span class="il"></span> </strong></a></font></td>
                                                        <td width="4%">&nbsp;</td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                            ...
                            <tr>
                                ...
                                <td width="96%" align="left" style="border-top:1px solid #000000" height="50">
                                    <font style="font-family:'Myriad Pro',Helvetica,Arial,sans-serif;color:#68696a;font-size:18px">
                                        <strong>
                                            Restablecimiento de clave personal
                                        </strong>
                                    </font>
                                </td>
                                <td width="1%">&nbsp;</td>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td width="96%" align="justify" valign="middle" style="font-family:Verdana,Geneva,sans-serif;color:#68696a;font-size:12px;line-height:16px">
                                    ...
                                    <br>
                                <p><a href="http://{{$host}}/auth/login?k={{$k}}" target="_blank" >Restablecer Clave</a></p>
